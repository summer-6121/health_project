...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "XGipgjhLTbPe_w5MGdJXGlGLONzKshSlw5K-eNI2";
    private static final String SECRETKEY = "0-cHueipqlizY_pdCg8PHuDrlGerQ2x3UmciMo8k";
    private static final String BUCKET = "summer6121";
    public static final String DOMAIN= "http://qgzrdsz8v.hn-bkt.clouddn.com/";
